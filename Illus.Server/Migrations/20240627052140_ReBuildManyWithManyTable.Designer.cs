...
namespace Illus.Server.Migrations
{
    ...
    [Migration("20240627052140_ReBuildManyWithManyTable")]
    partial class ReBuildManyWithManyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtworkTag", b =>
                {
                    b.HasOne("Illus.Server.Models.ArtworkModel", null)
                        .WithMany()
                        .HasForeignKey("ArtworksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Illus.Server.Models.TagModel", null)
                        .WithMany()
